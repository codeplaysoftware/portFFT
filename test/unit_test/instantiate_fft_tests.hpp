...
INSTANTIATE_TEST_SUITE_P(workItemTest, FFTTest,
                         ::testing::ConvertGenerator<basic_param_tuple>(
                             ::testing::Combine(packed_and_transposed, fwd_and_bwd, ::testing::Values(1, 3, 33000),
...
INSTANTIATE_TEST_SUITE_P(workItemOrSubgroupTest, FFTTest,
                         ::testing::ConvertGenerator<basic_param_tuple>(::testing::Combine(packed_and_transposed,
                                                                                           fwd_and_bwd,
...
INSTANTIATE_TEST_SUITE_P(SubgroupTest, FFTTest,
                         ::testing::ConvertGenerator<basic_param_tuple>(
                             ::testing::Combine(packed_and_transposed, fwd_and_bwd, ::testing::Values(1, 3, 555),
                                                ::testing::Values(64, 96, 128))));

INSTANTIATE_TEST_SUITE_P(SubgroupOrWorkgroupTest, FFTTest,
                         ::testing::ConvertGenerator<basic_param_tuple>(
                             ::testing::Combine(packed_and_transposed, fwd_and_bwd, ::testing::Values(1, 3),
...
INSTANTIATE_TEST_SUITE_P(BackwardTest, FFTTest,
                         ::testing::ConvertGenerator<basic_param_tuple>(
                             ::testing::Combine(packed_and_transposed, fwd_and_bwd, ::testing::Values(1),
...
INSTANTIATE_TEST_SUITE_P(StridedTest, FFTTest,
                         ::testing::ConvertGenerator<stride_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, ::testing::Values(1, 3), ::testing::Values(4, 128, 4096),
                                                s_strides, s_strides)));

// TODO: Remove
// In-place tests are failing, out-of-place are passing.
// Scratch output buffer is valid and properly copied back to the inout pointer.
// Only half of the output elements seems to be copied back to the host.
// Buffer out-of-place are failing with: C++ exception with description "NULL pointer argument in memory copy operation. -30 (PI_ERROR_INVALID_VALUE)" thrown in the test body.
using strides_t = std::vector<std::size_t>;
INSTANTIATE_TEST_SUITE_P(DbgTest, FFTTest,
                         ::testing::ConvertGenerator<stride_param_tuple>(::testing::Combine(
                             fwd_and_bwd, ::testing::Values(1), ::testing::Values(256),
                             ::testing::Values(strides_t{0, 2}), ::testing::Values(strides_t{0, 64}))));
...
INSTANTIATE_TEST_SUITE_P(DistanceWorkItemTest, FFTTest,
                         ::testing::ConvertGenerator<distance_param_tuple>(::testing::Combine(
                             fwd_and_bwd, d_batch, ::testing::Values(4), dwi_distance, dwi_distance)));
auto dsg_distance = ::testing::Values(129, 200);
INSTANTIATE_TEST_SUITE_P(DistanceSubgroupTest, FFTTest,
                         ::testing::ConvertGenerator<distance_param_tuple>(::testing::Combine(
                             fwd_and_bwd, d_batch, ::testing::Values(128), dsg_distance, dsg_distance)));
auto dwg_distance = ::testing::Values(4097, 4100);
INSTANTIATE_TEST_SUITE_P(DistanceWorkgroupTest, FFTTest,
                         ::testing::ConvertGenerator<distance_param_tuple>(::testing::Combine(
                             fwd_and_bwd, d_batch, ::testing::Values(4096), dwg_distance, dwg_distance)));
...
INSTANTIATE_TEST_SUITE_P(StridedDistanceWorkItemBothDirTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, sdwi_batch, sdwi_length, sdwi_strides, sdwi_strides,
                                                sdwi_distance, sdwi_distance)));
INSTANTIATE_TEST_SUITE_P(StridedDistanceWorkItemFwdTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_only, sdwi_batch, sdwi_length, sdwi_strides, sd_default_strides,
                                                sdwi_distance, sdwi_default_distance)));
INSTANTIATE_TEST_SUITE_P(StridedDistanceWorkItemBwdTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(bwd_only, sdwi_batch, sdwi_length, sd_default_strides, sdwi_strides,
                                                sdwi_default_distance, sdwi_distance)));
...
INSTANTIATE_TEST_SUITE_P(StridedDistanceSubgroupBothDirTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, sdsg_batch, sdsg_length, sdsg_strides, sdsg_strides,
                                                sdsg_distance, sdsg_distance)));
INSTANTIATE_TEST_SUITE_P(StridedDistanceSubgroupFwdTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_only, sdsg_batch, sdsg_length, sdsg_strides, sd_default_strides,
                                                sdsg_distance, sdwi_default_distance)));
INSTANTIATE_TEST_SUITE_P(StridedDistanceSubgroupBwdTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(bwd_only, sdsg_batch, sdsg_length, sd_default_strides, sdsg_strides,
                                                sdwi_default_distance, sdsg_distance)));
...
INSTANTIATE_TEST_SUITE_P(StridedDistanceWorkgroupBothDirTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, sdwg_batch, sdwg_length, sdwg_strides, sdwg_strides,
                                                sdwg_distance, sdwg_distance)));
INSTANTIATE_TEST_SUITE_P(StridedDistanceWorkgroupFwdTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_only, sdwg_batch, sdwg_length, sdwg_strides, sd_default_strides,
                                                sdwg_distance, sdwg_default_distance)));
INSTANTIATE_TEST_SUITE_P(StridedDistanceWorkgroupBwdTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(bwd_only, sdwg_batch, sdwg_length, sd_default_strides, sdwg_strides,
                                                sdwg_default_distance, sdwg_distance)));
...
INSTANTIATE_TEST_SUITE_P(BatchInterleavedWorkItemTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, bi_batch, ::testing::Values(16), bi_strides, bi_strides,
                                                bi_distance, bi_distance)));
INSTANTIATE_TEST_SUITE_P(BatchInterleavedSubgroupTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, bi_batch, ::testing::Values(128), bi_strides, bi_strides,
                                                bi_distance, bi_distance)));
INSTANTIATE_TEST_SUITE_P(BatchInterleavedWorkgroupTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, bi_batch, ::testing::Values(4096), bi_strides, bi_strides,
                                                bi_distance, bi_distance)));
...
INSTANTIATE_TEST_SUITE_P(BatchInterleavedLargerStrideDistanceTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, ::testing::Values(20), ::testing::Values(16), bils_strides,
                                                bils_strides, bils_distance, bils_distance)));
...
INSTANTIATE_TEST_SUITE_P(ArbitraryInterleavedTest, FFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, ::testing::Values(4), ::testing::Values(4), ai_strides,
                                                ai_strides, ai_distance, ai_distance)));
...
INSTANTIATE_TEST_SUITE_P(OverlapReadFwdTest, FFTTest,
                         ::testing::ConvertGenerator<distance_param_tuple>(
                             ::testing::Combine(fwd_only, ::testing::Values(3), ::testing::Values(4),
                                                ::testing::Values(1), ::testing::Values(4))));
INSTANTIATE_TEST_SUITE_P(OverlapReadBwdTest, FFTTest,
                         ::testing::ConvertGenerator<distance_param_tuple>(
                             ::testing::Combine(bwd_only, ::testing::Values(3), ::testing::Values(4),
...
INSTANTIATE_TEST_SUITE_P(InvalidLengthTest, InvalidFFTTest,
                         ::testing::ConvertGenerator<basic_param_tuple>(::testing::Combine(unpacked, fwd_and_bwd, one,
                                                                                           zero)));
INSTANTIATE_TEST_SUITE_P(InvalidBatchTest, InvalidFFTTest,
                         ::testing::ConvertGenerator<basic_param_tuple>(::testing::Combine(unpacked, fwd_and_bwd, zero,
                                                                                           one)));
...
INSTANTIATE_TEST_SUITE_P(InvalidFwdStridesTest, InvalidFFTTest,
                         ::testing::ConvertGenerator<stride_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, one, one, invalid_strides, valid_strides)));
INSTANTIATE_TEST_SUITE_P(InvalidBwdStridesTest, InvalidFFTTest,
                         ::testing::ConvertGenerator<stride_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, one, one, valid_strides, invalid_strides)));
INSTANTIATE_TEST_SUITE_P(InvalidFwdDistanceTest, InvalidFFTTest,
                         ::testing::ConvertGenerator<distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, ::testing::Values(2), one, zero, one)));
INSTANTIATE_TEST_SUITE_P(InvalidBwdDistanceTest, InvalidFFTTest,
                         ::testing::ConvertGenerator<distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, ::testing::Values(2), one, one, zero)));
INSTANTIATE_TEST_SUITE_P(InvalidSmallDistanceTest, InvalidFFTTest,
                         ::testing::ConvertGenerator<distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, ::testing::Values(2), ::testing::Values(4),
...
INSTANTIATE_TEST_SUITE_P(InvalidSmallStrideTest, InvalidFFTTest,
                         ::testing::ConvertGenerator<stride_distance_param_tuple>(
                             ::testing::Combine(fwd_and_bwd, ::testing::Values(6), ::testing::Values(3), iss_strides,
                                                iss_strides, iss_distance, iss_distance)));
...
#define INSTANTIATE_TESTS_FULL(TYPE, TYPE_NAME, PLACEMENT, PLACEMENT_NAME, MEM, MEM_NAME) \
  TEST_P(FFTTest, MEM_NAME##_##PLACEMENT_NAME##_C2C_##TYPE_NAME) {                        \
    auto param = GetParam();                                                              \
    sycl::queue queue;                                                                    \
    ...
    check_fft_##MEM<TYPE, placement::PLACEMENT>(param, queue);                            \
  }

#define INSTANTIATE_TESTS_MEM(TYPE, TYPE_NAME, PLACEMENT, PLACEMENT_NAME)      \
  INSTANTIATE_TESTS_FULL(TYPE, TYPE_NAME, PLACEMENT, PLACEMENT_NAME, usm, USM) \
  INSTANTIATE_TESTS_FULL(TYPE, TYPE_NAME, PLACEMENT, PLACEMENT_NAME, buffer, BUFFER)

#define INSTANTIATE_TESTS(TYPE, TYPE_NAME)             \
  INSTANTIATE_TESTS_MEM(TYPE, TYPE_NAME, IN_PLACE, IP) \
  INSTANTIATE_TESTS_MEM(TYPE, TYPE_NAME, OUT_OF_PLACE, OOP)
...
#define INSTANTIATE_INVALID_TESTS_FULL(PLACEMENT, PLACEMENT_NAME) \
  TEST_P(InvalidFFTTest, PLACEMENT_NAME##_C2C) {                  \
    auto param = GetParam();                                      \
    sycl::queue queue;                                            \
    check_invalid_fft<placement::PLACEMENT>(param, queue);        \
  }

#define INSTANTIATE_INVALID_TESTS()            \
  INSTANTIATE_INVALID_TESTS_FULL(IN_PLACE, IP) \
  INSTANTIATE_INVALID_TESTS_FULL(OUT_OF_PLACE, OOP)
