...
#define INTANTIATE_TESTS(TYPE, TYPE_NAME, PLACEMENT, PLACEMENT_NAME, TRANSPOSE, TRANSPOSE_NAME, DIRECTION, DIRECTION_NAME, DIRECTION_TEST_SUITE, MEM, MEM_NAME) \
...
#define INTANTIATE_TESTS_MEM(TYPE, TYPE_NAME, PLACEMENT, PLACEMENT_NAME, TRANSPOSE, TRANSPOSE_NAME, DIRECTION, DIRECTION_NAME, DIRECTION_TEST_SUITE) \
INTANTIATE_TESTS(TYPE, TYPE_NAME, PLACEMENT, PLACEMENT_NAME, TRANSPOSE, TRANSPOSE_NAME, DIRECTION, DIRECTION_NAME, DIRECTION_TEST_SUITE, usm, USM) \
INTANTIATE_TESTS(TYPE, TYPE_NAME, PLACEMENT, PLACEMENT_NAME, TRANSPOSE, TRANSPOSE_NAME, DIRECTION, DIRECTION_NAME, DIRECTION_TEST_SUITE, buffer, BUFFER)
