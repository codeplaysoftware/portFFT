...
inline void local2global(T_loc_ptr local, T_glob_ptr global, std::size_t total_num_elems, std::size_t local_size, 
    ...
    global2local(local,global, total_num_elems,local_size, local_id, local_offset, global_offset);
}
...
inline void local2private(T_loc_ptr local, T_priv_ptr priv, std::size_t local_id, std::size_t stride, std::size_t local_offset=0){
...
*/
template<std::size_t num_elems_per_wi, typename T_loc_ptr, typename T_priv_ptr>
inline void local2private_transposed(T_loc_ptr local, T_priv_ptr priv, std::size_t local_id, std::size_t workers_in_sg, std::size_t local_offset=0){
    for(std::size_t i=0;i<num_elems_per_wi;i++){
...
inline void private2local(T_priv_ptr priv, T_loc_ptr local, std::size_t local_id, std::size_t stride, std::size_t local_offset=0){
    for(std::size_t i=0;i<num_elems_per_wi;i++){
